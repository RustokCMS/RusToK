...
- **многоязычность (RU/EN) включаем сразу**, а не "потом".
...
- [ ] RU/EN namespace-структура (auth, dashboard, users, security, common)
...
- все новые и затронутые тексты локализованы RU/EN;
